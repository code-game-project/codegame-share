...
func (s *Server) storeEntry(entryType EntryType, data any) (string, error) {
	...
	_, err = s.DB.Exec("INSERT INTO entries (id, created, type, data) VALUES (?, ?, ?, ?)", id, created, entryType, jsonData)
	if err != nil {
